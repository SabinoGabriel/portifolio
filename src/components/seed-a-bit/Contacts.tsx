...
const Contact = () => {
  return (
    <section id="contato" className="w-full py-20 px-6 text-center bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="flex justify-center items-center space-x-8">
        ...
        <a
          href="https://www.linkedin.com/in/gabriel-sabino-leite-198a04100/" // SEU LINK DO LINKEDIN
          target="_blank"
          rel="noopener noreferrer"
          aria-label="LinkedIn"
          className="text-gray-500 dark:text-gray-400 hover:text-pink-500 dark:hover:text-pink-400 transition-colors text-4xl"
